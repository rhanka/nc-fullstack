...
- [ ] L6.10b Spécifier et implémenter `a220_image_caption_v2` avec `routing_profile_v1`. Recette: `gpt-5.4-nano` produit caption + typage de contenu + indices RAG/Wiki; un replay benchmark compare les décisions de routage aux gains observés de `gpt-5.4`, puis fige une matrice de routage avant le full rebuild. `TEST`
